        ...
        <Script id="google-analytics">
          ...
          <div className='intro_content mt-40'>
            ...
            <p>As a UX designer, I&apos;m passionate about the human element in my work. 
              ...
              <Link href={'https://drive.google.com/file/d/1hTt53MEkU1F4BCmVPvfNnZA9BOeZRc-z/view?usp=share_link'}><h3 className='underline-offset-8 mt-4 underline text-blue-700'>View full resume</h3></Link>
            </div>    
          </div>
